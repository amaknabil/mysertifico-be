...
const {logoModel} = require('./logos.model'); // Corrected import to match filename
...
const Logos = logoModel(db); // Corrected model initialization
...
module.exports = {User, ContactUs, Role, Logos, App, UserRole, Organization, UserOrganizationRole, Batch, Recipient, Template}
